...
TeviRuleToPoptacker = {
    ...
    "EVENT_SnowSHOP":"^$EVENT_SnowSHOP",
    "EVENT_ValhallaSHOP":"^$EVENT_ValhallaSHOP",
    "EVENT_TartarusSHOP":"^$EVENT_TartarusSHOP",
    "EVENT_AnathemaSHOP":"^$EVENT_AnathemaSHOP",
    "EVENT_MoroseSHOP":"^$EVENT_MoroseSHOP",
